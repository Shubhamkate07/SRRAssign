...
// import './DonateBook.css'; // Assuming you have some custom CSS
...
//     const updatedBooks = books.filter((ele,ind)=>{
//       return index!=ind;
//     });
//     setBooks(updatedBooks);
//   };
...
//       toast.error("lease add at least one book!", {
//           position:'top-center' ,
...
//   const Alldetails=()=>{
//     console.log('book dtaataat',books);
